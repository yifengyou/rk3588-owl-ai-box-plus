...
wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/radxa_linux-6.1-stan-rkr5.1_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/radxa_linux-6.1-stan-rkr5.1_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/radxa_linux-6.1-stan-rkr5.1_kernel/config-linux-6.1-stan-rkr5.1-kdev
ls -alh config-linux-6.1-stan-rkr5.1-kdev
md5sum config-linux-6.1-stan-rkr5.1-kdev

wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/radxa_linux-6.1-stan-rkr5.1_kernel/System.map-linux-6.1-stan-rkr5.1-kdev
ls -alh System.map-linux-6.1-stan-rkr5.1-kdev
md5sum System.map-linux-6.1-stan-rkr5.1-kdev

wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/radxa_linux-6.1-stan-rkr5.1_kernel/rk3588-owl-ai-box-plus-v10.dtb
ls -alh rk3588-owl-ai-box-plus-v10.dtb
md5sum rk3588-owl-ai-box-plus-v10.dtb

wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/radxa_linux-6.1-stan-rkr5.1_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
...
cp -f Image /mnt/vmlinuz-linux-6.1-stan-rkr5.1-kdev
cp -f config-linux-6.1-stan-rkr5.1-kdev /mnt/config-linux-6.1-stan-rkr5.1-kdev
cp -f System.map-linux-6.1-stan-rkr5.1-kdev /mnt/System.map-linux-6.1-stan-rkr5.1-kdev
touch /mnt/initrd.img-linux-6.1-stan-rkr5.1-kdev
...
label l0
	...
	linux vmlinuz-linux-6.1-stan-rkr5.1-kdev
	initrd initrd.img-linux-6.1-stan-rkr5.1-kdev
