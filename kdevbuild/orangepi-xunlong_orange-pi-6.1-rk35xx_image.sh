...
export BUILD_TAG="OWL_orange-pi-6.1-rk35xx_${set_rootfs}"
...
wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/orangepi-xunlong_orange-pi-6.1-rk35xx_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/orangepi-xunlong_orange-pi-6.1-rk35xx_kernel/Image
ls -alh Image
md5sum Image
...
wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/orangepi-xunlong_orange-pi-6.1-rk35xx_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
