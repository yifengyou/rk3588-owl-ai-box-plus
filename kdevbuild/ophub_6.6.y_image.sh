...
wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/ophub_6.6.y_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/ophub_6.6.y_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/ophub_6.6.y_kernel/config-6.6.y-kdev
ls -alh config-6.6.y-kdev
md5sum config-6.6.y-kdev

wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/ophub_6.6.y_kernel/System.map-6.6.y-kdev
ls -alh System.map-6.6.y-kdev
md5sum System.map-6.6.y-kdev

wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/ophub_6.6.y_kernel/rk3588-evb1-lp4-v10-linux.dtb
ls -alh rk3588-evb1-lp4-v10-linux.dtb
md5sum rk3588-evb1-lp4-v10-linux.dtb

wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/ophub_6.6.y_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
...
mkdir -p /mnt/dtb
cp -a rk3588-evb1-lp4-v10-linux.dtb /mnt/dtb/
...
label l0
	...
	fdt /dtb/rk3588-evb1-lp4-v10-linux.dtb
