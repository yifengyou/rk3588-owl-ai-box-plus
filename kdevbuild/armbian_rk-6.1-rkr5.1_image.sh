...
wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/armbian_rk-6.1-rkr5.1_kernel/uboot.img
ls -alh uboot.img
...
wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/armbian_rk-6.1-rkr5.1_kernel/Image
ls -alh Image
md5sum Image
...
wget -c https://github.com/yifengyou/rk3588-owl-ai-box-plus/releases/download/armbian_rk-6.1-rkr5.1_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
